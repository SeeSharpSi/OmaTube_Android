...
- Reuse the three bundled theme palettes exactly. Do not apply Material defaults or dynamic colors. Small screens need constrained wrapping and scrolling, not an unrelated mobile redesign. Player chrome follows `qml/PlayerControls.qml`.
